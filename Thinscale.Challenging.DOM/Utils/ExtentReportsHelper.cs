...
namespace ReportingLibrary
{
    public class ExtentReportsHelper
    {
        ...
        public ExtentReportsHelper()
        {
            ...
            reporter = new ExtentV3HtmlReporter(@"/Challenging.DOM/Thinscale.Challenging.DOM/Thinscale.Challenging.DOM/Reports/"" + DateTime.Now.ToString(""MM_dd_yy"" + "" / "" + ""HH_mm_ss"") + ""_ExtentReport.HTML"); 
